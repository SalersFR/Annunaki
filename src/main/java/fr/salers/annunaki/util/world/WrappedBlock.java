...
public class WrappedBlock {
    ...
    private boolean loaded, water, lava, solid, ice, slime, soulSand, web, piston, fence, fenceGate, wall, door, slab, stairs, carpet, anvil;
    private String name;
